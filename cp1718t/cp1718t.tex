...
\\[\blanklineskip]%
\>[B]{}\Varid{ledger}\mathrel{=}\Varid{m}\comp \Varid{col}\comp \Varid{cataList}\;\alt{\Varid{nil}}{\mathsf{conc}\comp (\mathsf{conc}\comp \Varid{sp}\comp \conj{\Varid{l}}{\Varid{r}}{}\<[74]%
\>[74]{}\times\Varid{id})}\comp \Varid{allTransactions}{}\<[E]%
\\
\>[B]{}\hsindent{9}{}\<[9]%
