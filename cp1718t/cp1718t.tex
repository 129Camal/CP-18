...
\\
\>[B]{}\Varid{outBlockchain}\;(\Conid{Bcs}\;\Varid{a})\mathrel{=}i_2\;\Varid{a}{}\<[E]%
\\
...
&
      \ensuremath{\Conid{Transactions}}
           \ar[r]^-{\cata{g}}
&
      \ensuremath{(\Conid{Entity}\times\Conid{Value})\mathbin{*}}
            \ar[d]^-{\ensuremath{\Varid{col}}}
\\
      \ensuremath{\Conid{Ledger}}   
&
&
      \ensuremath{(\Conid{Entity}\times\Conid{Value}\mathbin{*})\mathbin{*}}
           \ar[ll]^-{\ensuremath{\map \;(\Varid{id}\times\Varid{sum})}}
}
\end{eqnarray*}
...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{ledger}\mathrel{=}\Varid{m}\comp \Varid{col}\comp \Varid{cataList}\;\alt{\Varid{nil}}{\mathsf{conc}\comp (\mathsf{conc}\comp \Varid{sp}\comp \conj{\Varid{l}}{\Varid{r}}{}\<[73]%
\>[73]{}\times\Varid{id})}\comp \Varid{allTransactions}{}\<[E]%
\\
\>[B]{}\hsindent{9}{}\<[9]%
\>[9]{}\mathbf{where}\;\Varid{sp}\mathrel{=}(\Varid{singl}\times\Varid{singl}){}\<[E]%
\\
\>[9]{}\hsindent{6}{}\<[15]%
\>[15]{}\Varid{l}\mathrel{=}(\Varid{id}\times\Varid{negate}\comp \p1){}\<[E]%
\\
\>[9]{}\hsindent{6}{}\<[15]%
\>[15]{}\Varid{r}\mathrel{=}\Varid{swap}\comp \p2{}\<[E]%
\\
\>[9]{}\hsindent{6}{}\<[15]%
\>[15]{}\Varid{m}\mathrel{=}\map \;(\Varid{id}\times\Varid{sum}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\xymatrix@C=2cm{
      \ensuremath{\Conid{BlockChain}}
           ...
           \ar[r]_-{\ensuremath{\Varid{cataBlockchain}}}      
&
      \ensuremath{\Conid{MagicNumber}\mathbin{*}}
           \ar[d]^-{\ensuremath{\conj{\Varid{id}}{\Varid{nub}}}}
\\
      \ensuremath{\Conid{Bool}}   
&
      \ensuremath{(\Conid{MagicNo}\mathbin{*},\Conid{MagicNo}\mathbin{*})}
            \ar[l]_-{\ensuremath{\uncurry{(\equiv )}}}
}
\end{eqnarray*}
...
\column{9}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{isValidMagicNr}\mathrel{=}\Varid{eq}\comp \conj{\Varid{id}}{\Varid{nub}}\comp \Varid{cataBlockchain}\;\alt{\Varid{singl}\comp \p1}{\Varid{cons}\comp (\p1\times\Varid{id})}{}\<[E]%
\\
\>[B]{}\hsindent{9}{}\<[9]%
\>[9]{}\mathbf{where}\;\Varid{eq}\mathrel{=}\uncurry{(\equiv )}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\
\>[B]{}\Varid{baseQTree}\;\Varid{h}\;\Varid{f}\mathrel{=}(\Varid{h}\times\Varid{id})+(\Varid{f}\times(\Varid{f}\times(\Varid{f}\times\Varid{f}))){}\<[E]%
\\
\>[B]{}\Varid{recQTree}\;\Varid{f}\mathrel{=}\Varid{baseQTree}\;\Varid{id}\;\Varid{f}{}\<[E]%
\\
\>[B]{}\Varid{cataQTree}\;\Varid{g}{}\<[14]%
\>[14]{}\mathrel{=}\Varid{g}\comp \Varid{recQTree}\;(\Varid{cataQTree}\;\Varid{g})\comp \Varid{outQTree}{}\<[E]%
\\
\>[B]{}\Varid{anaQTree}\;\Varid{g}\mathrel{=}\Varid{inQTree}\comp \Varid{recQTree}\;(\Varid{anaQTree}\;\Varid{g})\comp \Varid{g}{}\<[E]%
\\
\>[B]{}\Varid{hyloQTree}\;\Varid{f}\;\Varid{h}\mathrel{=}\Varid{cataQTree}\;\Varid{f}\comp \Varid{anaQTree}\;\Varid{h}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mathbf{instance}\;\Conid{Functor}\;\Conid{QTree}\;\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mathsf{fmap}\;\Varid{g}\mathrel{=}\Varid{cataQTree}\;(\Varid{inQTree}\comp {}\<[36]%
\>[36]{}\Varid{baseQTree}\;\Varid{g}\;\Varid{id}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{rotateQTree}\mathrel{=}\Varid{cataQTree}\;(\Varid{inQTree}\comp ((\Varid{id}\times\Varid{swap})+\conj{\p1\comp \p2\comp \p2}{\conj{\p1}{\conj{\p2\comp \p2\comp \p2}{\p1\comp \p2}}})){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{scaleQTree}\;\Varid{n}\mathrel{=}\Varid{anaQTree}\;(((\Varid{id}\times((\Varid{n}\mathbin{*})\times(\Varid{n}\mathbin{*})))+\Varid{id})\comp \Varid{outQTree}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{invertQTree}\mathrel{=}\mathsf{fmap}\;(\Varid{invertPixel}){}\<[E]%
\\
\>[B]{}\Varid{invertPixel}\;(\Conid{PixelRGBA8}\;\Varid{a}\;\Varid{b}\;\Varid{c}\;\Varid{d})\mathrel{=}\Conid{PixelRGBA8}\;(\mathrm{255}\mathbin{-}\Varid{a})\;(\mathrm{255}\mathbin{-}\Varid{b})\;(\mathrm{255}\mathbin{-}\Varid{c})\;\Varid{d}{}\<[E]%
\\[\blanklineskip]%
...
\just\equiv{ Igualdade extensional; Cancelamento-x}
  \ensuremath{\begin{lcbr}\Varid{l}\;\Varid{k}\comp \underline{\mathrm{0}}\mathrel{=}\succ \comp \Varid{k}\\\Varid{l}\;\Varid{k}\comp \succ \mathrel{=}\succ \comp \p2\comp \conj{\Varid{f}\;\Varid{k}}{\Varid{l}\;\Varid{k}}\end{lcbr}}
\just\equiv{Eq-+}
%
\ensuremath{\alt{\Varid{l}\;\Varid{k}\comp \underline{\mathrm{0}}}{\Varid{l}\;\Varid{k}\comp \succ }\mathrel{=}\alt{\succ \comp \Varid{k}}{\succ \comp \p2\comp \conj{\Varid{f}\;\Varid{k}}{\Varid{l}\;\Varid{k}}}}
\just\equiv{ Fusão-+; in = \ensuremath{\alt{\underline{\mathrm{0}}}{\succ }} ; Absorção-+}
%
...
\just\equiv{ Igualdade extensional\{73\}; (d + k  + 1) = l k d}
        \ensuremath{\begin{lcbr}\Varid{f}\;\Varid{k}\comp \underline{\mathrm{0}}\mathrel{=}\underline{\mathrm{1}}\\\Varid{f}\;\Varid{k}\comp \succ \mathrel{=}\Varid{mul}\;\conj{\Varid{f}\;\Varid{k}}{\Varid{l}\;\Varid{k}}\end{lcbr}}
\just\equiv{ Eq-+}

\ensuremath{\alt{\Varid{f}\;\Varid{k}\comp \underline{\mathrm{0}}}{\Varid{f}\;\Varid{k}\comp \succ }\mathrel{=}\alt{\underline{\mathrm{1}}}{\Varid{mul}\;\conj{\Varid{l}\;\Varid{k}}{\Varid{f}\;\Varid{k}}}}
\just\equiv{ Fusão-+; in = \ensuremath{\alt{\underline{\mathrm{0}}}{\succ }} ; Absorção-+}

\ensuremath{\Varid{f}\;\Varid{k}\comp \mathbf{in}\mathrel{=}\alt{\underline{\mathrm{1}}}{\Varid{mul}}\comp (\Varid{id}\mathbin{+}\conj{\Varid{l}\;\Varid{k}}{\Varid{f}\;\Varid{k}})}

\just\equiv{ F f = (id + f) }

\ensuremath{\Varid{f}\;\Varid{k}\comp \mathbf{in}\mathrel{=}\alt{\underline{\mathrm{1}}}{\Varid{mul}}\comp \Conid{F}\;\conj{\Varid{l}\;\Varid{k}}{\Varid{f}\;\Varid{k}}} $<=>$ \ensuremath{\Varid{f}\;\Varid{k}\comp \mathbf{in}\mathrel{=}\alt{\underline{\mathrm{1}}}{\Varid{mul}}\comp (\Varid{id}\mathbin{+}\conj{\Varid{l}\;\Varid{k}}{\Varid{f}\;\Varid{k}})}
\end{eqnarray*}
...
\ensuremath{\begin{lcbr}\Varid{f}\;\Varid{k}\comp \mathbf{in}\mathrel{=}\alt{\mathrm{1}}{\Varid{mul}}\comp (\Varid{id}\mathbin{+}\conj{\Varid{l}\;\Varid{k}}{\Varid{f}\;\Varid{k}})\\\Varid{l}\;\Varid{k}\comp \mathbf{in}\mathrel{=}\alt{\succ }{\succ }\comp \p2\comp (\Varid{id}\mathbin{+}\conj{\Varid{f}\;\Varid{k}}{\Varid{l}\;\Varid{k}})\end{lcbr}}
\more
...
\just\equiv{Fusão-+, Absorção-+}
  \ensuremath{\Varid{g}\comp \mathbf{in}\mathrel{=}\alt{\underline{\mathrm{1}}}{\Varid{mul}}\comp (\Varid{id}\mathbin{+}\conj{\Varid{s}}{\Varid{g}}}
\just\equiv{ F f = (id + f)}
%
\ensuremath{\Varid{g}\comp \mathbf{in}\mathrel{=}\alt{\underline{\mathrm{1}}}{\Varid{mul}}\comp \Conid{F}\;\conj{\Varid{s}}{\Varid{g}}} $<=>$\ensuremath{\alt{\underline{\mathrm{1}}}{\Varid{mul}}\comp (\Varid{id}\mathbin{+}\conj{\Varid{s}}{\Varid{g}})}
\qed
\end{eqnarray*}
...
\ensuremath{\begin{lcbr}\Varid{s}\comp \mathrm{0}\mathrel{=}\mathrm{1}\\\Varid{s}\comp \succ \mathrel{=}\succ \comp \p2\comp \conj{\Varid{g}}{\Varid{s}}\end{lcbr}}
\just\equiv{Eq-+}
  \ensuremath{\alt{\Varid{s}\comp \underline{\mathrm{0}}}{\Varid{s}\comp \succ }\mathrel{=}\alt{\underline{\mathrm{1}}}{\succ \comp \p2\comp \conj{\Varid{g}}{\Varid{s}}}}
\just\equiv{Fusão-+ ; in = [0, succ] ; Absorção-+ ; F f = id+f}
  \ensuremath{\Varid{s}\comp \mathbf{in}\mathrel{=}\alt{\mathrm{1}}{\succ \comp \p2}\comp (\Varid{id}\mathbin{+}\conj{\Varid{g}}{\Varid{s}})}
\qed
\end{eqnarray*}
...
\start
\just\equiv{Fokkinga ;in = [0,succ]}
\ensuremath{\begin{lcbr}\Varid{g}\comp \mathbf{in}\mathrel{=}\alt{\mathrm{1}}{\Varid{mul}}\comp (\Varid{id}\mathbin{+}\conj{\Varid{s}}{\Varid{g}})\\\Varid{s}\comp \mathbf{in}\mathrel{=}\alt{\mathrm{1}}{\succ }\comp (\Varid{id}\mathbin{+}\conj{\Varid{g}}{\Varid{s}})\end{lcbr}}
\ensuremath{\conj{\Varid{g}}{\Varid{s}}\mathrel{=}(\Varid{cata}\;\conj{\alt{\mathrm{1}}{\Varid{mul}}}{\alt{\mathrm{1}}{\succ }\comp \p2})}
\qed
\end{eqnarray*}
...
\just\equiv{ Eq-+ }
    \ensuremath{\underline{\Varid{base}}\mathrel{=}\conj{\conj{\Varid{one}}{\succ }}{\conj{\Varid{one}}{\Varid{one}}}}
\more
...
\begin{eqnarray*}
\xymatrix@C=2cm{
      \ensuremath{\Conid{Integer}}
           \ar[r]_-{\ensuremath{\conj{\conj{\Varid{one}}{\succ }}{\conj{\Varid{one}}{\Varid{one}}}}} 
           \ar[d]_-{\ensuremath{\Varid{base}}}    
&
      \ensuremath{((\Conid{Integer},\Conid{Integer}),(\Conid{Integer},\Conid{Integer}))}
           \ar[dl]^-{\ensuremath{\Varid{f}}}
\\
      \ensuremath{(\Conid{Integer},\Conid{Integer},\Conid{Integer},\Conid{Integer})}  
}
\end{eqnarray*}
...
\column{7}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{base}\mathrel{=}\Varid{f}\comp \conj{\conj{\Varid{one}}{\succ }}{\conj{\Varid{one}}{\Varid{one}}}{}\<[E]%
\\
\>[B]{}\hsindent{7}{}\<[7]%
\>[7]{}\mathbf{where}\;\Varid{f}\;((\Varid{x1},\Varid{y1}),(\Varid{x2},\Varid{y2}))\mathrel{=}(\Varid{x1},\Varid{y1},\Varid{x2},\Varid{y2}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
&
      \ensuremath{((\Conid{Integer},\Conid{Integer}),(\Conid{Integer},\Conid{Integer}))}
           \ar[d]^-{\ensuremath{\conj{\conj{\Varid{mul}\comp \p1}{\succ \comp \p2\comp \p1}}{\conj{\Varid{mul}\comp \p2}{\succ \comp \p2\comp \p2}}}}
\\
      \ensuremath{(\Conid{Integer},\Conid{Integer},\Conid{Integer},\Conid{Integer})} 
&
      \ensuremath{((\Conid{Integer},\Conid{Integer}),(\Conid{Integer},\Conid{Integer}))}
...
\column{13}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{loop}\mathrel{=}\Varid{g}\comp \conj{\conj{\Varid{mul}\comp \p1}{\succ \comp \p2\comp \p1}}{\conj{\Varid{mul}\comp \p2}{\succ \comp \p2\comp \p2}}\comp \Varid{f}{}\<[E]%
\\
\>[B]{}\hsindent{7}{}\<[7]%
\>[7]{}\mathbf{where}\;\Varid{f}\;(\Varid{x1},\Varid{y1},\Varid{x2},\Varid{y2})\mathrel{=}((\Varid{x1},\Varid{y1}),(\Varid{x2},\Varid{y2})){}\<[E]%
\\
\>[7]{}\hsindent{6}{}\<[13]%
\>[13]{}\Varid{g}\;((\Varid{x1},\Varid{y1}),(\Varid{x2},\Varid{y2}))\mathrel{=}(\Varid{x1},\Varid{y1},\Varid{x2},\Varid{y2}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{5}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{inFTree}\mathrel{=}\alt{\Conid{Unit}}{\uncurry{\uncurry{\Conid{Comp}}}\comp \Varid{assocl}}{}\<[E]%
\\
...
\\
\>[B]{}\Varid{baseFTree}\;\Varid{x}\;\Varid{y}\;\Varid{z}\mathrel{=}\Varid{y}+(\Varid{x}\times(\Varid{z}\times\Varid{z})){}\<[E]%
\\
\>[B]{}\Varid{recFTree}\;\Varid{x}\mathrel{=}\Varid{baseFTree}\;\Varid{id}\;\Varid{id}\;\Varid{x}{}\<[E]%
\\
...
\\
      \ensuremath{\mathit B\;(\Varid{a},\Conid{Int})\mathbin{*}} 
&
      \ensuremath{(\Varid{a},\Conid{Int})\mathbin{*}}
...
&
      \ensuremath{[\mskip1.5mu ([\mskip1.5mu (\Varid{a},\Conid{Int})\mskip1.5mu],\Conid{Int})\mskip1.5mu]}
          \ar[d]_-{\ensuremath{\map \;(\Varid{subsilia})}}
\\
...
\column{7}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\mu \mathrel{=}\mathit B\comp \Varid{concat}\comp \map \;(\Varid{subsilia})\comp \Varid{unB}\comp \mathsf{fmap}\;\Varid{unB}{}\<[E]%
\\
\>[B]{}\hsindent{7}{}\<[7]%
\>[7]{}\mathbf{where}\;\Varid{subsilia}\;(\Varid{a},\Varid{b})\mathrel{=}\map \;(\Varid{id}\times(\mathbin{*}\Varid{b}))\;\Varid{a}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
&
      \ensuremath{[\mskip1.5mu (\Varid{a},\Conid{Int})\mskip1.5mu]}
           \ar[d]^-{\ensuremath{\Varid{aux}\comp \conj{\Varid{id}}{\Varid{sum}\comp \map \;(\p2)}}}
\\
      \ensuremath{\Conid{D}\;[\mskip1.5mu (\Varid{a},\Conid{Float})\mskip1.5mu]} 
&
      \ensuremath{[\mskip1.5mu (\Varid{a},\Conid{Float})\mskip1.5mu]}
          \ar[l]_-{\ensuremath{\Conid{D}}}    
}
\end{eqnarray*}
...
\column{7}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{dist}\mathrel{=}\Conid{D}\comp \Varid{aux}\comp \conj{\Varid{id}}{\Varid{sum}\comp \map \;(\p2)}\comp \Varid{unB}{}\<[E]%
\\
\>[B]{}\hsindent{7}{}\<[7]%
\>[7]{}\mathbf{where}\;\Varid{aux}\;(\Varid{a},\Varid{b})\mathrel{=}\map \;(\lambda (\Varid{c},\Varid{d})\to (\Varid{a},(\Varid{toFloat}\;\Varid{d}\mathbin{/}\Varid{toFloat}\;\Varid{b})))\;\Varid{a}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
